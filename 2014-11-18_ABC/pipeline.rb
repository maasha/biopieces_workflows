...
#uchime_ref.
#write_table(output: "p4_original_OTU_names.txt", header: true, force: true, keys: [:SEQ_NAME]).  #TODO
...
run(verbose: true, output_dir: out_dir, report: "p7.html")
